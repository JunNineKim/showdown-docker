...
chmod -R 775 /transmission /showdown /output /showdown-manager
chown -R $PUID:$PGID /transmission /showdown /output /showdown-manager

# Run services
transmission-daemon -g /transmission/config
php-fpm7
nginx
